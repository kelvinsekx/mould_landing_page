...
const Footer = () => {
  return (
    <footer className={"bg-moundUpBlack text-moundUpWhite " + styles.footer}>
      <Container>
        <div className="grid grid-cols-[1fr_1fr] justify-center gap-10 lg:grid-cols-[1fr_1fr_1fr_1fr] text-base py-10 px-4">
          {data.map((menu, index) => (
            <Footer.UL key={index} {...menu} />
          ))}

          <ul>
            <header className="font-extrabold mb-4 text-xl">Community</header>
            <li>
              <a
        ...
        <div className="text-center py-10">
          <InlineIcons />
          <p className="pt-[18px] text-[0.64rem]">
...
const UL = ({ title, items }: { title: string; items: string[] }) => {
  return (
    <ul>
      <header className="font-extrabold mb-4 text-xl">{title}</header>
...
const InlineIcons = () => (
  <span className="flex justify-center gap-2">
    <a
      href="https://web.facebook.com/people/MoundUp-Africa/100075793212356/"
      target="_blank"
      rel="noopener noreferrer"
    >
      <svg
    ...
    <a
      href="mailto:info@moundup.africa"
      target="_blank"
      rel="noopener noreferrer"
    >
      <svg
    ...
    <a
      href="https://www.linkedin.com/company/moundup-africa"
      target="_blank"
      rel="noopener noreferrer"
    >
    ...
    <a
      href="https://twitter.com/MoundUp_Africa"
      target="_blank"
      rel="noopener noreferrer"
    >
      <svg
